...
function App() {
  ...
  const [currentLivestream, setLivestream] = useState(
    "https://youtu.be/TURbeWK2wwg?autoplay=0&mute=&start=0"
  );
  ...
  const [video, setVideo] = useState(
    `//https://youtu.be/TURbeWK2wwg?autoplay=0&mute=0&start=0`
  );

  // <------------- Radio Change section -------------->

  const LofiGirlVideo = () => {
    setVideo("//https://www.youtube.com/watch?v=jfKfPfyJRdk?autoplay=1&mute=1&start=1");
    setStationName("LofiGirl");
    setYoutubeChannal(
      "https://www.youtube.com/channel/UCSJ4gkVC6NrvII8umztf0Ow"
    );
    setLivestream("https://www.youtube.com/watch?v=jfKfPfyJRdk?autoplay=1&mute=1&start=1");
    playLiveStream(true);
    setPauseScreen("unpauseScreen");
    setPlayPause(pauseImg);
    setBtnClass("PlayPause2");
  ...
  const StudyMD = () => {
    setVideo("//https://youtu.be/7ROADQAqhOo?autoplay=1&mute=0&start=0");
    setStationName("StudyMD");
    setYoutubeChannal("https://www.youtube.com/c/StudyMD");
    setLivestream("https://youtu.be/7ROADQAqhOo?autoplay=1&mute=0&start=0");
    playLiveStream(true);
    setPauseScreen("unpauseScreen");
    setPlayPause(pauseImg);
    setBtnClass("PlayPause2");
  ...
  const mrsiro = () => {
    setVideo("//https://www.youtube.com/watch?v=LKChoK8R4-Q?autoplay=1&mute=1&start=0");
    setStationName("Mr. Siro");
    setYoutubeChannal("https://www.youtube.com/c/AnimeVibe");
    setLivestream(
      "https://youtu.be/677y_h-YNMc"
    );
    playLiveStream(true);
    setPauseScreen("unpauseScreen");
    setPlayPause(pauseImg);
  ...
  return (
    <div className="interfaceContainer">
      <div className="radioContainer">
        <div className="logo">my Radio playlist</div>
